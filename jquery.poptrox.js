            ...
            // Main
                ...
                $caption
                    .on('update', function(e, s, slide) {
                        ...
                        $popup.trigger('poptrox_caption_init', [s, slide]);
                    ...
                    .on('poptrox_switch', function(e, slide, ignoreLock) {
                        ...
                        if (settings.popupIsFixed) {
                            ...
                            $x.load(function() {
                                ...
                                $x.off('load');
                                $loader.hide().trigger('stopSpinning');
                                $caption.trigger('update', [x.captionText, slide]).fadeIn(settings.fadeSpeed);
                ...
                var open = function (link, e) {
                    ...
                    var index = getSlides().index(link),
                        img = link.find('img'),
